...
@Component({
  selector: 'app-root',
  templateUrl: './instial.component.html',
  styleUrls: ['./instial.component.scss']
})
export class InstialComponent implements OnInit {
  public token: string;
  ...
  getProfile(){
    ...
    this.http.get("http://mainlook.com:8080/api/profile",options)
        .subscribe(response =>{
